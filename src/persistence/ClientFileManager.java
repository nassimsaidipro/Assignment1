    ...
    public static void saveClients(Client[] clients, int count, String filePath) throws IOException {
        ...
        try (PrintWriter writer = new PrintWriter(new FileWriter(filePath))) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                writer.println(c.getClientId() + ";" + c.getFirstName() + ";" + c.getLastName() + ";" + c.getEmailAdress() +  ";" + c.getTotalSpent());
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(filePath))) {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                try {
                    ...
                    // Call the public backdoor constructor to recreate the Client with its original ID
